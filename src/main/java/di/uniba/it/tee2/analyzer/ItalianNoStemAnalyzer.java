 ...
 * @author pierpaolo
 */
public class ItalianNoStemAnalyzer extends StopwordAnalyzerBase {
     ...
     * @param matchVersion
     */
    public ItalianNoStemAnalyzer(Version matchVersion) {
     ...
     */
    public ItalianNoStemAnalyzer(Version matchVersion, CharArraySet stopwords) {
     ...
     */
    public ItalianNoStemAnalyzer(Version matchVersion, CharArraySet stopwords, CharArraySet stemExclusionSet) {
